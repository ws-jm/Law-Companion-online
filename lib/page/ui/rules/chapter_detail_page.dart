...
import 'package:ftv2/controller/rules/chapter_detail_controller.dart';
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    InkWell(
                      onTap: (){
                        controller.rulesController.selectedIndex.value  = controller.arg[3];
                        print(controller.rulesController.selectedIndex.value);
                        Get.back(result: [controller.data,controller.arg[0],controller.arg[1]]);
                        controller.rulesController.tabController.animateTo(controller.rulesController.selectedIndex.value += 1);
                      },
                      child: Container(
                        width: Get.width/1.3,
                        height: 50,
                    ...
                    InkWell(
                      onTap: (){
                        controller.rulesController.selectedIndex.value  = controller.arg[3];
                        Get.back(result: [controller.data,controller.arg[0],controller.arg[1]]);
                        controller.rulesController.tabController.animateTo(controller.rulesController.selectedIndex.value += 2);
                      },
                      child: Container(
                        height: 50,
                        width:50,
