...
class Rules1Page extends GetView<Rules1Controller> {
  const Rules1Page({Key? key}) : super(key: key);
                ...
                controller.searchResultLaws.length != 0 || controller.controller.text.isNotEmpty
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context,int index){
                        return InkWell(
                          onTap: () async {
                            controller.result = await Get.toNamed(AppRoute.chapterDetails,arguments:[ controller.searchResultLaws[index].url!,controller.searchResultLaws[index].rules!,1,0,true]);
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child:  RichText(
                                  text: TextSpan(
                                    children: highlightOccurrences(controller.searchResultLaws[index].rules!, controller.controller.text),
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context,int index){
                        return InkWell(
                          onTap: () async {
                            controller.result = await Get.toNamed(AppRoute.chapterDetails,arguments:[ controller.data[index].url!,controller.data[index].rules!,1,0,true]);
                            print(controller.result[0]);
                            print(controller.result[1]);
                          },
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: normalText(controller.data[index].rules!,
                                    15, Colors.white),
                              ),
                            ),
                          ),
